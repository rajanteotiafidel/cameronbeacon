...
//				targeting.setEndTime(endtime);
			...
			String urldata = "refresh_token=1/q-BzRTo3NFiZWmIO7_ZkBpbb0uFp-kWZW_mgjbcU-es"
	...
	private StringBuffer sendPost(String token, String beaconName, String json) throws Exception {
		...
		String url = "https://proximitybeacon.googleapis.com/v1beta1/"+beaconName+"/attachments?projectId=beacons-160503&fields=attachmentName%2CcreationTimeMs%2Cdata%2CnamespacedType&key=AIzaSyDwDjx6u8i7YId716VD1FrtCvo6BdRQGg8";
		URL obj = new URL(url);
...
//			targeting.setEndTime(endtime);
			...
			System.out.println("data JSON ===========;:>>>>>>>>>> "+json);
			String data = Base64.encodeBase64String(json.getBytes());
		    System.out.println("Base64 Attachment Data : " + data);
			...
			OAuthResponse googleReponse=gson.fromJson(httpresponse, OAuthResponse.class);
			System.out.println("google Response in AddAttachment === "+googleReponse.getAccess_token());
			StringBuffer beaconJSON = sendPost(googleReponse.getAccess_token(), beaconName, json);
	...
	private StringBuffer sendPost(String token, String beaconName, String json) throws Exception {
		...
		System.out.println("str AddAttachment List ------->>>>>> "+strbeaconList);
		return response;
	}
