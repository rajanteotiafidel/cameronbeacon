  	...
  	<section class="content" style="height:300px;padding-right:5px;margin-left:-5px;padding-left:2%;">
              ...
              <div class="modal-content">
                <div class="modal-body">
                  <ul class="nav nav-tabs" id="myTab">
                    ...
                    <li class=""><a data-target="#attachments" data-toggle="tab" style="cursor:pointer">Attachments</a></li>
                  </ul>
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="attachments">
                      <div class="panel-body clearfix">
                        <div class="form-group clearfix">
                          <label for="name" class="col-sm-12">Attachments :</label>
                          <div class="col-sm-12">
                          	<input class="form-control" name="aname" id="aname" type="text" value="" >
                          </div>
                          <div class="col-sm-12">
                          	<input class="form-control" name="aplace" id="aplace" type="text" value="" >
                          </div>
                        </div>
                      </div>
                    </div>
		...
		<div id="add" class="modal fade" role="dialog">
          ...
          <div class="col-sm-12"style="height:190%;padding-right:2px;padding-left:10px">
          	<div class="col-sm-4 pl panel searchlist" id="hidecol" style="width:39%;margin-left:-15px;height:105%">
			...
			<div class="col-sm-8 pr" style="width:62%;padding-right:0px;padding-left:5px;height:105%">
			<div id="map1"></div>
		</div>
	</div>
</section>
		   ...
		   var content = "";
			...
			console.log(bc);
		 	$.each(ac, function(i, item) {
				...
				console.log(ac);
	content += "<tr data-target='#detail' data-toggle='modal' onclick='bd(\""+bn+"\")' onmouseover=myMap1(\"" + llt + "," + llg+ "," + p+ "," + bn+ "\");>"
	 	 						+"<td style='padding-left:10px'>" + bn.bold() + ""
	 	 						+"<br>" + addy + "</td>"
